        ...
        if request.POST.get('step') == '1':
            ...
            if step3_form.is_valid():
                ...
                try:
                    ...
                    deliweight = creating_job.weight  # package weight

                    # Package size
                    delisize = creating_job.size
                    if delisize == "small":
                        ds = 1
                    elif delisize == "medium":
                        ds = 1.2
                    else:
                        ds = 1.5

                    creating_job.price = round(
                        (creating_job.distance * ds * deliweight*20), 2)  # $1 per km
                    # creating_job.price = creating_job.distance * ds * deliweight# $1 per km
                    creating_job.save()
